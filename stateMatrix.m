...
sma = SetGlobalTimer(sma,3,iff(TaskParameters.GUI.TimeOutBrokeFixation,TaskParameters.GUI.TimeOutBrokeFixation, 0.01));
sma = SetGlobalTimer(sma,4,iff(TaskParameters.GUI.TimeOutEarlyWithdrawal, TaskParameters.GUI.TimeOutEarlyWithdrawal, 0.01));
...
sma = AddState(sma, 'Name', 'CenterPortRewardDelivery',...
    ...
    'OutputActions', [RewardCenterPort AirFlowSamplingOff]);
...
sma = AddState(sma, 'Name', 'timeOut_BrokeFixation',...
    'Timer',LEDErrorRate,...
    'StateChangeConditions',{'GlobalTimer3_End','ITI','Tup','timeOut_BrokeFixationFlashOff'},...
    'OutputActions',ErrorFeedback);
sma = AddState(sma, 'Name', 'timeOut_BrokeFixationFlashOff',...
    'Timer',LEDErrorRate,...
...
sma = AddState(sma, 'Name', 'timeOut_EarlyWithdrawal',...
    'Timer',LEDErrorRate,...
    'StateChangeConditions',{'GlobalTimer4_End','ITI','Tup','timeOut_EarlyWithdrawalFlashOff'},...
    'OutputActions',ErrorFeedback);
sma = AddState(sma, 'Name', 'timeOut_EarlyWithdrawalFlashOff',...
    'Timer',LEDErrorRate,...
